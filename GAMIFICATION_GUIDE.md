...
Player has correct streak of 3, answers question in 4 seconds:
...
- 🥈 2nd Place
- 🥉 3rd Place
- 4. Numbered positions after top 3
...
**Settings: 30 second timer (90 max points)**

**Question 1:**
- Player A answers correctly in 2 seconds
- Points: 90 × 1.0 = 90 (Streak: 1)
- Total: 90

**Question 2:**
- Player A answers correctly in 5 seconds
- Points: (90 - 2) × 1.125 = 99 (Streak: 2)
- Total: 189
...
1. **Speed Matters** - Answer in first 3 seconds for maximum points
2. **Build Streaks** - Consistent correct answers multiply your points
3. **Accuracy First** - Wrong answers reset streak, costing potential points
4. **Early Bird** - Players answering faster on each question build up scores faster
...
These settings adjust the scoring:
```python
base_points = timer_seconds × 3
(e.g., 30 sec timer = 90 max points)
(e.g., 60 sec timer = 180 max points)
```

- Answer in **first 3 seconds** = full base points
- After 3 seconds = -1 point per second
...
- [ ] Time-based point calculation works correctly
- [ ] Streak multiplier increases on consecutive correct answers
- [ ] Streak resets on incorrect answer
- [ ] Leaderboard updates in real-time
- [ ] Timer displays accurately on quiz page
- [ ] Point breakdown shows all components
- [ ] Database stores answer_time_ms correctly
